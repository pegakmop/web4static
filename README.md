...
3. Открыть веб-интерфейс в [отдельном окне ip:port](http://192.168.1.1:88/)
или
[отдельном окне ip:port/w4s/](http://192.168.1.1:88/w4s/)
   - Ручной запуск скрипта для удаления/установки/обновления через `web4static` или `/opt/share/www/w4s/web4static.sh`
